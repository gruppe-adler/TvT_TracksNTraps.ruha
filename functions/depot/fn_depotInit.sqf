...
SB_DEPOTS_VEHICLE_WEST = "gm_ge_army_u1300l_repair";
SB_DEPOTS_VEHICLE_EAST = "gm_gc_army_ural4320_repair"; // empty string to allow placement everywhere, else its only allowed near on of the listed vehicles
