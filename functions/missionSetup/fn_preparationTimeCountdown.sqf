...
private _message = if (_timeLeft > 0) then {
    "<t font='RobotoCondensed'>Game starts in: <br/>%1</t>"
} else {
     playSound "TacticalPing";
     "<t font='RobotoCondensed' size='1.2'>&#160;</t><br/><t color='#00ff00'>Game on!</t>";
     "<t font='RobotoCondensed' valign='middle' size='2' color='#00ff00'>Game on!</t>";
};
